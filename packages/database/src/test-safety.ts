...
export async function resetTestDatabase(pool: Pool) {
  ...
  await pool.query(`TRUNCATE
    serp_provider_reservations,serp_api_captures,serp_provider_usage_periods,serp_provider_configs,
    browser_capture_tokens,serp_captures,owner_facts,evidence_items,evidence_requests,
    opportunity_runs,
